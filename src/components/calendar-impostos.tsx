...
import { useMemo, type Dispatch, type SetStateAction, useCallback } from "react"
...
export default function MonthYearPicker({
    ...
    // 1. Geração da lista de anos (mantida)
    const years = useMemo(() => {
        const yearsList = []
    ...
    const handleYearChange = (newYearStr: string) => {
        updateDate(selectedMonthStr, newYearStr)
    }
    ...
    return (
        <div className="flex gap-3">
            <div className="flex flex-col gap-2 flex-1">
                ...
                >
                    <SelectTrigger id="select-month" className="w-[120px] justify-between focus:!ring-[1px] ml-0.5 font-normal text-my-foreground-secondary bg-my-background-secondary border-0 hover:bg-my-background-secondary hover:text-my-foreground-secondary cursor-pointer">
            ...
            <div className="flex flex-col gap-2 flex-1">
                <Label htmlFor="select-year" className="text-sm pl-2">Ano</Label>
                <Select
                    value={selectedYearStr} // 💡 Usa a prop derivada
                    onValueChange={handleYearChange} // 💡 Usa o manipulador imediato
                >
                    <SelectTrigger id="select-year" className="w-[full] justify-between focus:!ring-[1px] ml-0.5 font-normal text-my-foreground-secondary bg-my-background-secondary border-0 hover:bg-my-background-secondary hover:text-my-foreground-secondary cursor-pointer">
